...
sudo docker run -d -p 8888:8080 --name network-graph -v $(pwd)/pcap-to-neo-web/yo/app:/var/lib/jetty/webapps/pcap-to-neo-web/ -v /home/danny/Neo4J/Pcap.db:/home/danny/Neo4J/Pcap.db -v /home/danny/pcapIn/:/home/danny/pcapIn jetty:latest
